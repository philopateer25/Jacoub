            ...
            <section className="bg-slate-800 rounded-lg border border-slate-700 overflow-hidden">
                ...
                {loading ? (
                    ...
                    <div className="divide-y divide-slate-700">
                        {messages.map((msg) => (
                            <div key={msg.id} className="p-6 flex items-center justify-between hover:bg-slate-700/50 transition-colors">
                                <div>
                                ...
                                <div className="flex items-center gap-4">
                                    <audio controls src={msg.fileUrl} className="h-10 w-64" />
                                </div>
                            </div>
                        ))}
                    </div>
